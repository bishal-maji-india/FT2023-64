...
$first_name_err = $last_name_err = $img_upload_err = $mark_err = $phone_error = "";
...
if (array_key_exists('submit', $_POST)) {
  ...
  if ($first_name_err == "" && $last_name_err == "" && $mark_err == "" && $phone_error == "") {
...
<body>
  <div class="container">
    <form name="task_four_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
      ...
      <h4>Number : <input type="number" name="phone"> <br><span class="error">* <?php echo $phone_error; ?></span></h4>
