...
$first_name_err = $last_name_err = $img_upload_err = $mark_err = "";
...
// this event is trigred on submit button click
if (array_key_exists('submit', $_POST)) {
    ini_set('display_errors', 1);
    ini_set('display_startup_errors', 1);
    error_reporting(E_ALL);
    if ($first_name_err == "" && $last_name_err == "" && $mark_err == "") {
...
<body>
    <div class="container">
        <form name="task_three_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
